...
const SIDEBAR_ITEMS = [
  ...
  // { name: "Overview", image: MENU_IMAGES.overview, href: "/dashboard/overview" },
...
const SETTINGS_ITEMS = [
  // { name: "Admin Settings & Roles", image: MENU_IMAGES.adminSettings, href: "/dashboard/admin-settings" },
];
...
const Sidebar = () => {
  ...
  return (
    <div className={`sidebar-container ${isMobile ? 'mobile' : 'desktop'} ${isCollapsed ? 'collapsed' : ''}`}>
        ...
        <nav className="nav-menu">
          {SIDEBAR_ITEMS.map((item) => (
            <Link
              key={item.href}
              to={item.href}
              className={location.pathname === item.href ? "active-nav-item" : ""}
            >
